...
import '../../common/logger/vochat_dio_logger.dart';

/// See https://github.com/Milad-Akarie/pretty_dio_logger/blob/master/lib/pretty_dio_logger.dart
class VochatLoggerInterceptor extends Interceptor {
  ...
  VochatLoggerInterceptor({
    ...
    this.maxWidth = 90,
    this.compact = true,
    this.logPrint = VochatDioLogger.d,
  });
  ...
  void _printRequestHeader(RequestOptions options) {
    ...
    /// FileLogger
    VochatDioLogger.d("Request", "[$method]: ${uri.toString()}");
  }
