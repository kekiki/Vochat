...
import '../utils/colive_path_util.dart';

class ColiveLogUtil {
  static late final Logger _fileLogger;
  static late final Logger _consoleLogger;

  static String get logFilePath => "${ColivePathUtil.logPath}log.txt";

  ColiveLogUtil._internal();
  ...
  static Future<void> init() async {
    final logFileName = "${ColivePathUtil.logPath}log.txt";
  ...
  static void upload() async {
    ...
    final tempFile =
        await file.copy("${ColivePathUtil.logPath}${timestamp}_temp_log.txt");
