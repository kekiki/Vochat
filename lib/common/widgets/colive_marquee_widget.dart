...
class ColiveMarqueeWidget extends StatefulWidget {
  const ColiveMarqueeWidget(
      {required this.child, this.speed = 10, super.key});
  final Widget child;
  final int speed;

  @override
  State<ColiveMarqueeWidget> createState() => _ColiveMarqueeWidgetState();
}

class _ColiveMarqueeWidgetState extends State<ColiveMarqueeWidget>
