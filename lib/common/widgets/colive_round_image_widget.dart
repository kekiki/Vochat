...
import '../adapts/colive_screen_adapt.dart';

class ColiveRoundImageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (imageUrl.isURL || RegExp(r'^http').hasMatch(imageUrl)) {
      image = CachedNetworkImage(
        ...
        maxWidthDiskCache: ColiveScreenAdapt.screenWidth.toInt(),
        maxHeightDiskCache: ColiveScreenAdapt.screenHeight.toInt(),
      );
