...
class VochatShakeWidget extends StatefulWidget {
  const VochatShakeWidget({
    super.key,
    required this.child,
  ...
  @override
  State<VochatShakeWidget> createState() => _VochatShakeWidgetState();
}

class _VochatShakeWidgetState extends State<VochatShakeWidget> {
