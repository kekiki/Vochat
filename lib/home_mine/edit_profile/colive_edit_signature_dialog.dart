...
class ColiveEditSignatureDialog extends StatelessWidget {
  const ColiveEditSignatureDialog({super.key, required this.controller});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintText: 'colive_signature_place'.tr,
          ...
          Obx(() {
            final text = '(${lengthObs.value}/300)';
            return SizedBox(
