...
import '../../../services/models/colive_call_record_model.dart';
...
class ColiveCallRecordsWidget extends StatefulWidget {
  const ColiveCallRecordsWidget({super.key});

  @override
  State<ColiveCallRecordsWidget> createState() =>
      _ColiveCallRecordsWidgetState();
}

class _ColiveCallRecordsWidgetState extends State<ColiveCallRecordsWidget>
    with AutomaticKeepAliveClientMixin {
  final _apiClient = Get.find<ColiveApiClient>();

  List<ColiveCallRecordModel> _recordList = [];
  ...
  void _onRefresh() async {
    try {
      ...
      final result = await _apiClient
          .fetchCallRecordList('$_currentPage', '$_pageSize')
          .response;
  ...
  Widget _buildRecordItem(ColiveCallRecordModel record) {
    return SizedBox(
      height: 76.pt,
      child: Row(
        children: [
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  ColiveFormatUtil.millisecondsToTime(record.endTime * 1000),
          ...
          Column(
            ...
            children: [
              ...
              SizedBox(height: 4.pt),
              Text(
                '${'colive_call_duration'.tr}: ${ColiveFormatUtil.durationToTime(
                  record.conversationTime,
                  isShowHour: false,
                )}',
