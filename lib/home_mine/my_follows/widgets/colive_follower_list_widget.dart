...
import '../../../services/models/colive_follower_model.dart';
...
class ColiveFollowerListWidget extends StatefulWidget {
  const ColiveFollowerListWidget({super.key});

  @override
  State<ColiveFollowerListWidget> createState() =>
      _ColiveFollowerListWidgetState();
}

class _ColiveFollowerListWidgetState extends State<ColiveFollowerListWidget>
...
// data
  ...
  @override
  void didUpdateWidget(covariant ColiveFollowerListWidget oldWidget) {
  ...
  Future<ColiveApiResponse<List<ColiveFollowerModel>>> _fetchAnchorList({
    required int page,
    required int size,
  }) async {
  ...
  Future<void> _saveAnchorList(List<ColiveFollowerModel> list) async {
