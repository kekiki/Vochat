...
import 'colive_moment_mine_controller.dart';

class ColiveMomentMineWidget extends GetView<ColiveMomentMineController> {
  const ColiveMomentMineWidget({super.key});
