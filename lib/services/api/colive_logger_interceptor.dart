...
import '../../common/logger/colive_dio_logger.dart';

/// See https://github.com/Milad-Akarie/pretty_dio_logger/blob/master/lib/pretty_dio_logger.dart
class ColiveLoggerInterceptor extends Interceptor {
  ...
  ColiveLoggerInterceptor({
    ...
    this.maxWidth = 90,
    this.compact = true,
    this.logPrint = ColiveDioLogger.d,
  });
  ...
  void _printRequestHeader(RequestOptions options) {
    ...
    /// FileLogger
    ColiveDioLogger.d("Request", "[$method]: ${uri.toString()}");
  }
