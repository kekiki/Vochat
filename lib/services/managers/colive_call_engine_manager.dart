...
class ColiveCallEngineManager {
  ColiveCallEngineManager._internal();

  static ColiveCallEngineManager? _instance;
  static ColiveCallEngineManager get instance =>
      _instance ??= ColiveCallEngineManager._internal();
  ...
  Future<void> _init() async {
    ...
    ZegoEngineProfile profile = ZegoEngineProfile(
      ColiveAppConfig.zegoAppId,
      ZegoScenario.StandardVideoCall,
      appSign: ColiveAppConfig.zegoAppSign,
    );
  ...
  Future<void> enterRoom(
    ...
    ColiveLogUtil.i(_tag, "login: roomId=$roomId, userId=$userId");
  ...
  Future<void> exitRoom(String? roomId) async {
    ColiveLogUtil.i(_tag, "logout: roomId=$roomId");
  ...
  Future<void> _checkIfNeedDestroyView(int viewId) async {
    if (viewId == 0) {
      ColiveLogUtil.d(_tag, "_checkIfNeedDestroyView: viewId=$viewId");
      return;
    }
