...
part 'colive_block_model.g.dart';

@JsonSerializable()
class ColiveBlockModel extends Object {
  @JsonKey(name: 'area')
  String? area;
  ...
  factory ColiveBlockModel.fromJson(Map<String, dynamic> srcJson) =>
      _$ColiveBlockModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$ColiveBlockModelToJson(this);
}
