//
//  ColiveCallSettlementModel.dart
//
//
...
part 'colive_call_settlement_model.g.dart';

@JsonSerializable()
class ColiveCallSettlementModel extends Object {
  ...
  factory ColiveCallSettlementModel.fromJson(Map<String, dynamic> json) =>
      // _$ColiveCallSettlementModelFromJson(srcJson);
      ColiveCallSettlementModel(
  ...
  Map<String, dynamic> toJson() => _$ColiveCallSettlementModelToJson(this);
}
