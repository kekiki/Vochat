...
part 'colive_follow_model.g.dart';

@JsonSerializable()
class ColiveFollowModel extends Object {
  @JsonKey(name: 'area')
  String? area;
  ...
  factory ColiveFollowModel.fromJson(Map<String, dynamic> srcJson) =>
      _$ColiveFollowModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$ColiveFollowModelToJson(this);
}
