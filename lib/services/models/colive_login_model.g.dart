...
part of 'colive_login_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ColiveLoginModel _$ColiveLoginModelFromJson(Map<String, dynamic> json) =>
    ColiveLoginModel(
      (json['is_new'] as num?)?.toInt() ?? 0,
      json['token'] as String? ?? '',
      json['user'] == null
          ? null
          : ColiveLoginModelUser.fromJson(json['user'] as Map<String, dynamic>),
      json['msg'] == null
          ? null
          : ColiveBannedMsgModel.fromJson(json['msg'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ColiveLoginModelToJson(ColiveLoginModel instance) =>
    <String, dynamic>{
...
ColiveLoginModelUser _$ColiveLoginModelUserFromJson(
...
Map<String, dynamic> _$ColiveLoginModelUserToJson(
        ColiveLoginModelUser instance) =>
    <String, dynamic>{
...
ColiveBannedMsgModel _$ColiveBannedMsgModelFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$ColiveBannedMsgModelToJson(
        ColiveBannedMsgModel instance) =>
    <String, dynamic>{
