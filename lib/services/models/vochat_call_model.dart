...
part 'vochat_call_model.g.dart';

@JsonSerializable()
class VochatCallModel extends Object {
  ...
  factory VochatCallModel.fromJson(Map<String, dynamic> json) =>
      // _$VochatCallModelFromJson(srcJson);
      VochatCallModel(
  ...
  Map<String, dynamic> toJson() => _$VochatCallModelToJson(this);
}
