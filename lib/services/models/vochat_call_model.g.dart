...
part of 'vochat_call_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

VochatCallModel _$VochatCallModelFromJson(Map<String, dynamic> json) =>
    VochatCallModel(
...
Map<String, dynamic> _$VochatCallModelToJson(VochatCallModel instance) =>
    <String, dynamic>{
