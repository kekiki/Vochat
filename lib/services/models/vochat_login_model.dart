...
part 'vochat_login_model.g.dart';

@JsonSerializable()
class VochatLoginModel extends Object {
  ...
  @JsonKey(name: 'user')
  final VochatLoginModelUser? user;

  @JsonKey(name: 'msg')
  final VochatBannedMsgModel? msg;
  ...
  factory VochatLoginModel.fromJson(Map<String, dynamic> srcJson) =>
      _$VochatLoginModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$VochatLoginModelToJson(this);
}

@JsonSerializable()
class VochatLoginModelUser extends Object {
  ...
  factory VochatLoginModelUser.fromJson(Map<String, dynamic> json) =>
      // _$VochatLoginModelUserFromJson(json);
  ...
  Map<String, dynamic> toJson() => _$VochatLoginModelUserToJson(this);
}

@JsonSerializable()
class VochatBannedMsgModel extends Object {
  @JsonKey(name: 'reason')
  String? reason;
  ...
  factory VochatBannedMsgModel.fromJson(Map<String, dynamic> srcJson) =>
      _$VochatBannedMsgModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$VochatBannedMsgModelToJson(this);
}
