...
part 'vochat_order_item_model.g.dart';

@JsonSerializable()
@Entity(tableName: 'database_table_order_info')
class VochatOrderItemModel extends Object {
  ...
  factory VochatOrderItemModel.fromJson(Map<String, dynamic> srcJson) =>
      _$VochatOrderItemModelFromJson(srcJson);

  Map<String, dynamic> toJson() => _$VochatOrderItemModelToJson(this);
}
