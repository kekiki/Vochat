...
class ColiveGiftItemAnimateController extends GetxController
    with GetTickerProviderStateMixin {
  final Rx<ColiveGiftItemModel> gift = ColiveGiftItemModel.fromJson({}).obs;
  ...
  void addGift(ColiveGiftItemModel newGift,
      Function(ColiveGiftItemModel, bool) completion) {
